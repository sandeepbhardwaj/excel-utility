...
public class ExcelWriter {
	...
	static {
		...
		employees.add(new Employee("abc", "abc@example.com", dateOfBirth.getTime(), 1200000.0));

		dateOfBirth.set(1965, 10, 15);
		employees.add(new Employee("xyz", "xyz@example.com", dateOfBirth.getTime(), 1500000.0));

		dateOfBirth.set(1987, 4, 18);
		employees.add(new Employee("efg", "efg@example.com", dateOfBirth.getTime(), 1800000.0));
	}
	...
	public static void main(String[] args) throws IOException, InvalidFormatException {
		...
		// Create a Sheet
		Sheet s = workbook.createSheet("Employee");
		...
		sheet.enableLocking();
		sheet.setSheetPassword("xyz", null);
